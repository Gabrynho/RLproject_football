...
csv_files = [f for f in os.listdir('./DQN/episode_observations') if os.path.isfile(f) and f.startswith('level2_episode') and f.endswith('_observations.csv')]

for file in csv_files:
    # Check if the part between 'level2_episode' and '_observations.csv' is a number
    episode_number = file[len('level2_episode'):-len('_observations.csv')]
